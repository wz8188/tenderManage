		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="tmtendertype/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="TMTENDERTYPE_ID" id="TMTENDERTYPE_ID" value="${pd.TMTENDERTYPE_ID}"/>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		//保存
		function save(){
			if($("#TENDER_TYPE_NAME").val()==""){
				$("#TENDER_TYPE_NAME").tips({
					side:3,
		            msg:'请输入招标类别名称',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#TENDER_TYPE_NAME").focus();
			return false;
			}
			if($("#ITEM_NUMBER").val()==""){
				$("#ITEM_NUMBER").tips({
